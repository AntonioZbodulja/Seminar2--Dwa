...
$sqloglas="UPDATE $tbl_name1 SET naslov='" . $naslov . "', kratkiopis='" . $kratkiopis . "', dugiopis='" . $opis . "', cijena='" . $cijena . "', grad='" . $grad . "', brojosoba='" . $brojosoba . "', povrsina='" . $povrsina . "', brojzvjezdica='" . $zvjezdice . "', brojsoba='" . $brojsoba . "', udaljenostcentramjesta='" . $udaljenostcentramjesta . "', brojlezaja='" . $brojlezaja . "', minimalanbrojnocenja='" . $minbrojnocenja . "', blizinaplaze='" . $udaljenostodplaze . "', brojtelefona='" . $predbroj ." ". $broj. "', idzupanije='" . $zupanija . "', idkategorije='" . $vrstasmjestaja . "', lokacija='" . $lokacija . "' WHERE idoglasa='" . $idoglasa . "'";
...
$sqlkarakteristike="UPDATE $tbl_name2 SET grijanje='" . $grijanje . "', tv='" . $tv . "', internet='" . $internet . "', kabelska='" . $kabelska . "', kupaonica='" . $kupaonica . "', kuhinja='" . $kuhinja . "', dozvoljeniljubimci='" . $dozvoljeniljubimci . "', klima='" . $klima . "', terasa='" . $terasa . "', perilicarublja='" . $perilicarublja . "', hladnjak='" . $hladnjak . "', perilicasuda='" . $perilicasuda . "', pusenjedozvoljeno='" . $pusenjedozvoljeno . "', osiguranparking='" . $osiguranparking . "' WHERE idoglasa='" . $idoglasa . "'";
...
//ako je poslan file onda izvrsava kod
...
$resultslike5=mysql_query($sqlslike5);
 ...
 if($resultslike5){
  ...
  echo "Pogrešan format slike ili je slika prevelika.<br />";
   ...
   echo"Oglas je uspješno izmijenjen!";
} 
else { 
